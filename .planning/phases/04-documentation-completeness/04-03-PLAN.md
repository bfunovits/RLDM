...
wave: 3
depends_on: ["04-02"]
files_modified: ["R/*.R"]  # Will be specific files
autonomous: true
...
4. Save list to 04-03-SUMMARY.md with:
   - Functions missing examples entirely
   - Functions with examples that may need improvement (too long, missing set.seed, etc.)
   - Total count and files affected
  </action>
  <verify>04-03-SUMMARY.md exists with list of functions needing examples</verify>
  <done>Comprehensive list of functions missing examples and those needing improvement</done>
</task>
...
7. Record changes in 04-03-SUMMARY.md: which functions received examples, any issues fixed.
  </action>
