...
#>       s[1]  s[2]  s[3]  u[1] u[2]
#> s[1] -0.70 -0.71  0.02  0.01 0.01
#> s[2]  0.10 -0.07  0.37 -0.10 0.44
#> s[3] -0.03  0.26 -0.07  0.20 0.39
#> x[1] -1.11 -0.40  0.65  1.00 0.00
#> x[2]  0.39  0.86  0.52  0.00 1.00
...
#> s[1]  0.00  0.00 1.00  0.00 0.00  0.20 -0.32
#> s[2]  0.00  0.00 0.00  1.00 0.00  0.34  0.00
#> s[3] -0.31  0.31 0.59 -0.35 0.00 -0.13 -0.32
#> s[4]  0.00  0.00 0.00  0.00 1.00 -0.13 -0.20
#> s[5] -0.88  0.03 0.43  0.35 0.57  1.09 -0.25
#> x[1]  1.00  0.00 0.00  0.00 0.00  1.00  0.00
#> x[2]  0.00  1.00 0.00  0.00 0.00  0.49  1.00
#> x[3] -1.07 -0.17 0.00  0.00 0.00  0.12  0.47
#> Left square root of noise covariance Sigma:
#>       u[1] u[2]
#> u[1]  1.40 0.00
#> u[2] -2.35 1.31
