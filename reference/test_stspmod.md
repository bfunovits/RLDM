...
#>       s[1]  s[2]  s[3]  u[1] u[2]
#> s[1] -0.09 -0.46  0.41  0.30 0.45
#> s[2]  0.03 -0.32  0.00  0.55 0.56
#> s[3] -0.53  0.62  0.28 -0.33 0.31
#> x[1]  0.16 -0.50  0.12  1.00 0.00
#> x[2] -1.36 -0.69 -0.13  0.00 1.00
...
#> s[1]  0.00  0.00 1.00  0.00  0.00  0.15  0.21
#> s[2]  0.00  0.00 0.00  1.00  0.00 -0.32 -0.52
#> s[3]  0.04  0.24 0.45 -0.11  0.00  0.76 -0.29
#> s[4]  0.00  0.00 0.00  0.00  1.00 -0.05 -0.40
#> s[5] -0.09 -0.30 0.17  0.15 -0.35  0.20 -0.24
#> x[1]  1.00  0.00 0.00  0.00  0.00  1.00  0.00
#> x[2]  0.00  1.00 0.00  0.00  0.00  0.55  1.00
#> x[3]  0.50  0.19 0.00  0.00  0.00  0.47 -0.50
#> Left square root of noise covariance Sigma:
#>      u[1] u[2]
#> u[1] 1.15 0.00
#> u[2] 0.93 1.81
